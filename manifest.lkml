application: dashboard-summarization {
  ...
  entitlements: {
    ...
    external_api_urls: [
      "YOUR CLOUD RUN URL","https://naveen.ngrok.app","http://localhost:5000","http://localhost:5001","http://localhost:3000","https://*.googleapis.com","https://slack.com/api/*","https://slack.com/*"
    ]
    oauth2_urls: [
